...
Start-Process -WindowStyle hidden powershell {$x = [System.Net.Sockets.TcpListener]$port; $x.Start(); Start-Sleep -Seconds (30)} | Out-Null #opens port and sleeps to keep it open
